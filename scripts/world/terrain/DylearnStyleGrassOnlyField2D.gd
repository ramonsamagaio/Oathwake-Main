...
# Compatibility with the V5 scene serializer. These values are intentionally
# ignored by V6 rendering so an older local .tscn can still load after pull.
@export_category("V5 compatibility")
...
func _prepare_resources() -> void:
	...
	_grass_material.set_shader_parameter("palette_shadow", V6_PALETTE_SHADOW)
	_grass_material.set_shader_parameter("palette_dark_mid", V6_PALETTE_DARK_MID)
	_grass_material.set_shader_parameter("palette_mid_light", V6_PALETTE_MID_LIGHT)
	_grass_material.set_shader_parameter("palette_highlight", V6_PALETTE_HIGHLIGHT)
	_grass_material.set_shader_parameter("palette_field_scale_a", V6_FIELD_SCALE_A)
	_grass_material.set_shader_parameter("palette_field_scale_b", V6_FIELD_SCALE_B)
	_grass_material.set_shader_parameter("palette_threshold_1", V6_THRESHOLD_1)
	_grass_material.set_shader_parameter("palette_threshold_2", V6_THRESHOLD_2)
	_grass_material.set_shader_parameter("palette_threshold_3", V6_THRESHOLD_3)
	_grass_material.set_shader_parameter("stepped_time", _stepped_time)
