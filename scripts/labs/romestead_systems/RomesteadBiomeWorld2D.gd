...
const BASE_TERRAIN_PATH := EDITABLE_ROOT + "/floors/plainsgrass2.png"
const GREEN_TERRAIN_PATH := EDITABLE_ROOT + "/floors/short_grass.png"
const DIRT_TERRAIN_PATH := EDITABLE_ROOT + "/floors/plainsgrass3.png"
const FOREST_LIGHT_TERRAIN_PATH := EDITABLE_ROOT + "/floors/plainsgrass1.png"
const FOREST_DEEP_TERRAIN_PATH := EDITABLE_ROOT + "/floors/tall_grass.png"
const FOREST_PATH_PATH := EDITABLE_ROOT + "/floors/forest_path_short_grass_autumn.png"
const FOREST_BARRIER_BOTTOM_PATH := EDITABLE_ROOT + "/floors/forest_unbreakable_bushes_bottom_.png"
const FOREST_BARRIER_TOP_PATH := EDITABLE_ROOT + "/floors/forest_unbreakable_bushes_top_.png"
const FOREST_TREE_WALL_PATH := EDITABLE_ROOT + "/floors/tree_wall.png"
const FOREST_CANOPY_PATH := EDITABLE_ROOT + "/floors/canopy_.png"
const PLAINS_CLIFF_PATH := EDITABLE_ROOT + "/floors/plains_3D_cliffs.png"
const BASE_DETAILS_PATH := EDITABLE_ROOT + "/floors/plainsgrass2_details.png"
const GREEN_DETAILS_PATH := EDITABLE_ROOT + "/floors/shortgrass_details.png"
const DIRT_DETAILS_PATH := EDITABLE_ROOT + "/floors/plainsgrass3_details.png"
const TREE_STUMP_PATH := EDITABLE_ROOT + "/props/flora_stump.png"
const TREE_CANOPY_1_PATH := EDITABLE_ROOT + "/props/flora_tree1.png"
const TREE_CANOPY_2_PATH := EDITABLE_ROOT + "/props/flora_tree2.png"
const OLIVE_TREE_PATH := EDITABLE_ROOT + "/props/flora_olive_tree_large.png"
const OLIVE_STUMP_PATH := EDITABLE_ROOT + "/props/flora_olive_tree_stump.png"
const SKINNY_TREE_PATH := EDITABLE_ROOT + "/props/flora_skinny_tree.png"
const CYPRESS_PATH := EDITABLE_ROOT + "/props/flora_tall_cypress.png"
const ROCK_BIG_PATH := EDITABLE_ROOT + "/props/terrain_round_rocks_big.png"
const ROCK_SMALL_PATH := EDITABLE_ROOT + "/props/terrain_round_rocks_small.png"
const BUSH_PATH := EDITABLE_ROOT + "/props/flora_big_bushes1.png"
const GROUND_PLANTS_PATH := EDITABLE_ROOT + "/props/flora_ground_plants.png"
const WHEAT_PATH := EDITABLE_ROOT + "/props/flora_wheat_animated.png"
const APPLE_TREE_PATH := EDITABLE_ROOT + "/props/flora_apple_tree_large.png"
const APPLE_STUMP_PATH := EDITABLE_ROOT + "/props/flora_apple_tree_stump.png"
const STONE_PINE_PATH := EDITABLE_ROOT + "/props/flora_stone_pine_large.png"
const STONE_PINE_STUMP_PATH := EDITABLE_ROOT + "/props/flora_stone_pine_stump.png"
const MOSSY_BOULDER_PATH := EDITABLE_ROOT + "/props/poi_mossy_boulder_large.png"
const COPPER_ORE_PATH := EDITABLE_ROOT + "/props/resources_copper_ore.png"
const MUSHROOMS_PATH := EDITABLE_ROOT + "/props/flora_mushrooms.png"
const BELLFLOWERS_PATH := EDITABLE_ROOT + "/props/flora_bellflowers.png"
const PURPLE_BUSH_PATH := EDITABLE_ROOT + "/props/desert_purplebush.png"
const SMALL_BUSH_PATH := EDITABLE_ROOT + "/props/flora_small_bush1.png"
const TINY_FLOWERS_PATH := EDITABLE_ROOT + "/props/flora_tiny_flowers.png"
const TINY_LEAVES_PATH := EDITABLE_ROOT + "/props/flora_tiny_ground_leaves.png"
const BRAZIER_PATH := EDITABLE_ROOT + "/props/tier0_brazier.png"
