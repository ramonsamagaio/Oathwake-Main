...
const ACTIVE_VOLUME_DB := -22.0
const INACTIVE_VOLUME_DB := -80.0
...
func _setup_forest_ambience() -> void:
	...
	forest_ambience.volume_db = INACTIVE_VOLUME_DB
...
func _set_forest_ambience_active(is_active: bool) -> void:
	...
	_volume_tween.tween_property(forest_ambience, "volume_db", ACTIVE_VOLUME_DB if is_active else INACTIVE_VOLUME_DB, 1.0)
