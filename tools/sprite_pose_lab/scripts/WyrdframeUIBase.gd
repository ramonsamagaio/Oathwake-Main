...
func _build_ui() -> void:
	...
	center_split.add_child(_panel_card("INSPECTOR", call("_build_inspector") as Control, Vector2(285, 300)))
	root_split.add_child(_panel_card("TIMELINE", call("_build_timeline_panel") as Control, Vector2(600, 220)))
