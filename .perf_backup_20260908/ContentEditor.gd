...
func _build_world_gen_form() -> void:
	...
	_add_subsection_title("Tamanho do mundo")
	...
	_add_subsection_title("Borda do mundo")
	...
	_add_subsection_title("Água interior")
	...
	_add_subsection_title("Aglomerados de props")
...
func _add_spawn_table_editor() -> void:
	_add_subsection_title("Tabela de spawn")
	var note := Label.new()
